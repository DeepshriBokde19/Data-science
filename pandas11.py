...
data = {
    ...
    'Display Value': [0.00, 0.50, 1.62, 4.27, None]
}

world_alcohol = pd.DataFrame(data)


print("Shape of the dataset:", world_alcohol.shape)


print("Column names:", world_alcohol.columns.tolist())
